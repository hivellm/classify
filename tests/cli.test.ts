...
describe('CLI', () => {
  ...
  describe('document command', () => {
    it('should show not implemented message', () => {
      const output = execSync(`node ${CLI_PATH} document test.pdf`, { encoding: 'utf-8' });
  ...
  describe('batch command', () => {
    it('should show not implemented message', () => {
      const output = execSync(`node ${CLI_PATH} batch ./docs`, { encoding: 'utf-8' });
  ...
  describe('cache-stats command', () => {
    it('should show cache statistics header', () => {
      const output = execSync(`node ${CLI_PATH} cache-stats`, { encoding: 'utf-8' });
